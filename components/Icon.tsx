...
export const CubeIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    {/* Top Face */}
    <path d="M12 3.33L20 8L12 12.66L4 8L12 3.33Z" fill="currentColor" fillOpacity="0.9" stroke="none" />
    <path d="M12 3.33L20 8L12 12.66L4 8L12 3.33Z" stroke="currentColor" strokeOpacity="0.5" />

    {/* Right Face */}
    <path d="M20 8V17.33L12 22V12.66L20 8Z" fill="currentColor" fillOpacity="0.7" stroke="none" />
    <path d="M20 8V17.33L12 22V12.66L20 8Z" stroke="currentColor" strokeOpacity="0.5" />

    {/* Left Face */}
    <path d="M4 8V17.33L12 22V12.66L4 8Z" fill="currentColor" fillOpacity="0.8" stroke="none" />
    <path d="M4 8V17.33L12 22V12.66L4 8Z" stroke="currentColor" strokeOpacity="0.5" />
  </svg>
);
